...
const DEVELOPER_INTERNAL_PERMISSION_SET = Object.freeze([
  INTERNAL_PERMISSIONS.DOCS_READ_INTERNAL,
  INTERNAL_PERMISSIONS.API_KEYS_READ,
  INTERNAL_PERMISSIONS.AUDIT_LOGS_READ,
]);

const ROLE_PERMISSIONS = Object.freeze({
  admin: FULL_INTERNAL_PERMISSION_SET,
  developer: DEVELOPER_INTERNAL_PERMISSION_SET,
